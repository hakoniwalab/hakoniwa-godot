...
- [ ] `hakoniwa-pdu-endpoint` を native 側へ組み込む
- [ ] Godot から endpoint を生成できるようにする
- [ ] 接続設定 API を定義する
- [ ] 受信開始 / 停止 API を定義する
...
- [ ] Godot 側の公開クラス名を決める
- [ ] Node と Resource のどちらを中心にするか決める
- [ ] 受信 API を poll ベースにするか signal 併用にするか決める
- [ ] 設定 API と状態遷移を定義する
- [ ] ドキュメントに出す最小 API セットを定める
